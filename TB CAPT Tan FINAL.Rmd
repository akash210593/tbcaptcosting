...
params <- read.csv("parameters_tan.csv")

lambda <- 3 #change back to 0.7 for base case
#lambda_row <- 4
...
View(sim.out.df)
write.csv(sim.out.df, "Tan_sim.csv")
...
#write.csv(percentile_results,"lamdapointseven_results_tan.csv")

write.csv(ICER.df, "Tan_lamb3_ICER.csv")
